...
struct Rectangle
{
    ...
    explicit Rectangle(const int32_t inputX,
                       const int32_t inputY,
                       const int32_t inputW,
                       const int32_t inputH) : x(inputX),
                                               y(inputY),
                                               w(inputW),
                                               h(inputH)
    {
    ...
    explicit Rectangle(const Point & pos,
                       const int32_t inputW,
                       const int32_t inputH) :  x(pos.x),
                                                y(pos.y),
                                                w(inputW),
                                                h(inputH)
    {
     ...
     *  @returns bool            - is point inside or not
     * */
    inline static bool isPointInRect(const Point & point,
